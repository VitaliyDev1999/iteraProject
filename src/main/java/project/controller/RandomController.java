...
public class RandomController {
    ...
    @GetMapping(value = "/statistic/last")
    public List<Statistic> getStatisticLast(HttpServletRequest request) {
        return statisticService.getStatisticLast(request.getRemoteAddr());
    }
